...
class ImageGenerationEntity extends PollinationsAiEntityBase<ImageGeneration> {
  ...
  constructor(client: PollinationsAiSDK, entopts: any) {
    ...
    this.name_ = 'image_generation'
    this.Name = 'ImageGeneration'
  }


  make(this: ImageGenerationEntity) {
    return new ImageGenerationEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: ImageGenerationLoadMatch, ctrl?: Control): Promise<ImageGenerationEntity> {
