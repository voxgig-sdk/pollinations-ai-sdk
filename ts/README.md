# PollinationsAi TypeScript SDK



The TypeScript SDK for the PollinationsAi API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.GenerateText()` — each with a small set of operations (`load`, `create`)
...
| `tester(testopts?, sdkopts?)` | `PollinationsAiSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `PollinationsAiSDK.test(testopts?, sdkopts?)` | `PollinationsAiSDK` | Create a test-mode client. |
...
| `client` | `client(): PollinationsAiSDK` | Return the parent SDK client. |
...
pollinations-ai/
├── src/
│   ├── PollinationsAiSDK.ts        # Main SDK class
