...
AQL-driven CLI and REPL for the PollinationsAi SDK. Positional arguments are
...
```sh
go build -o pollinations-ai-cli ./...
```
...
./pollinations-ai-cli list generate_text
./pollinations-ai-cli load 1 generate_text
./pollinations-ai-cli load '{id:1}' generate_text
