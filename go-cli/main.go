// Command PollinationsAi-cli is a CLI + REPL for the PollinationsAi SDK,
...
const prompt = "pollinations-ai"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "generate_text image_generation"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      POLLINATIONS_AI_APIKEY (api key), POLLINATIONS_AI_BASE (base url override)")
