...
func registerSDKWords(r *eng.Registry, client *sdk.PollinationsAiSDK) {
...
func runOp(client *sdk.PollinationsAiSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
