// Command PollinationsAi-mcp is an MCP server exposing the PollinationsAi
// SDK as MCP tools.
//
// Two tools are registered:
//
//	PollinationsAi_list  — list records of an entity
//	PollinationsAi_load  — load a single record of an entity
//
