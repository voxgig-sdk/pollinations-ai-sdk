...
type Args struct {
	Entity string         `json:"entity" jsonschema:"generate_text | image_generation"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.PollinationsAiSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "pollinations-ai_list",
		Description: "List records from PollinationsAi. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "pollinations-ai_load",
		Description: "Load a single record from PollinationsAi. " +
...
func runOp(client *sdk.PollinationsAiSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.PollinationsAiSDK, name string) (sdk.PollinationsAiEntity, error) {
	switch strings.ToLower(name) {
	case "generate_text":
		return client.GenerateText(nil), nil
	case "image_generation":
		return client.ImageGeneration(nil), nil
