...
def make_error_util(ctx, err):
    if ctx is None:
        from projectname_sdk.core.context import PollinationsAiContext
        ctx = PollinationsAiContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, PollinationsAiError):
        errmsg = err.msg
    ...
    sdk_err = PollinationsAiError("", msg, ctx)
