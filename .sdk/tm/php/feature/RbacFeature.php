...
// PollinationsAi SDK rbac feature
...
class PollinationsAiRbacFeature extends PollinationsAiBaseFeature
{
    ...
    private function _required(PollinationsAiContext $ctx): ?string
    {
    ...
    private function _reject(PollinationsAiContext $ctx, string $required): void
    {
    ...
    private function _track(PollinationsAiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
