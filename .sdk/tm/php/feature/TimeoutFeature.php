...
// PollinationsAi SDK timeout feature
...
class PollinationsAiTimeoutFeature extends PollinationsAiBaseFeature
{
    ...
    private function _with_timeout(PollinationsAiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PollinationsAiContext $_ctx, float $ms): void
    {
        $client = $this->client;
