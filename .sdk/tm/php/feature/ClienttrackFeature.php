...
// PollinationsAi SDK clienttrack feature
...
class PollinationsAiClienttrackFeature extends PollinationsAiBaseFeature
{
    ...
    public function PostConstruct(PollinationsAiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'PollinationsAi-SDK';
