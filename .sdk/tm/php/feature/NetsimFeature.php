...
// PollinationsAi SDK netsim feature
...
class PollinationsAiNetsimFeature extends PollinationsAiBaseFeature
{
    ...
    private function _simulate(PollinationsAiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PollinationsAiContext $ctx, array $applied): void
    {
        $client = $this->client;
