...
// PollinationsAi SDK ratelimit feature
...
class PollinationsAiRatelimitFeature extends PollinationsAiBaseFeature
{
    ...
    private function _acquire(PollinationsAiContext $ctx): void
    {
    ...
    private function _track(PollinationsAiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
