...
// PollinationsAi SDK telemetry feature
...
class PollinationsAiTelemetryFeature extends PollinationsAiBaseFeature
{
    ...
    private function _close(PollinationsAiContext $ctx, bool $ok): void
    {
