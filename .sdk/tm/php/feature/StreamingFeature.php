...
// PollinationsAi SDK streaming feature
...
class PollinationsAiStreamingFeature extends PollinationsAiBaseFeature
{
    ...
    private function _iterate(PollinationsAiResult $result): \Generator
    {
    ...
    private function _streamable(PollinationsAiContext $ctx): bool
    {
