...
// PollinationsAi SDK debug feature
...
class PollinationsAiDebugFeature extends PollinationsAiBaseFeature
{
    ...
    private function _finish(PollinationsAiContext $ctx, bool $ok): void
    {
