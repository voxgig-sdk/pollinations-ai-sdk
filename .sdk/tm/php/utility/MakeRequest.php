...
// PollinationsAi SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class PollinationsAiMakeRequest
{
    public static function call(PollinationsAiContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new PollinationsAiResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new PollinationsAiResponse($fetched);
        } else {
