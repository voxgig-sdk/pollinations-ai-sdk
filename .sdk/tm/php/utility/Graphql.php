...
// PollinationsAi SDK utility: graphql
//
...
class PollinationsAiGraphql
{
    ...
    // equivalent.
    public static function body(PollinationsAiContext $ctx): mixed
    {
    ...
    public static function errors(PollinationsAiContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
