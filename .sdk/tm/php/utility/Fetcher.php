...
// PollinationsAi SDK utility: fetcher

class PollinationsAiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PollinationsAiSDK/1.0)';
    ...
    public static function call(PollinationsAiContext $ctx, string $fullurl, array $fetchdef): array
    {
