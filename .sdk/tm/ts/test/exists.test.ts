...
describe('exists', async () => {
  ...
  //
  // PollinationsAiSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof PollinationsAiSDK, true,
      'PollinationsAiSDK.test() must return a client synchronously')
  })
