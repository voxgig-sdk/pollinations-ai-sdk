...
describe("ImageGenerationDirect", function()
  it("should direct-load-image_generation", function()
    local setup = image_generation_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-image_generation", setup.live and "live" or "unit")
