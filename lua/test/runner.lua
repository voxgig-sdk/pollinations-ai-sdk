...
function runner.env_override(m)
  local live = runner.getenv("POLLINATIONSAI_TEST_LIVE")
  local override = runner.getenv("POLLINATIONSAI_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("POLLINATIONSAI_TEST_EXPLAIN")
