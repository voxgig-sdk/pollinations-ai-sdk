...
function runner.env_override(m)
  local live = runner.getenv("POLLINATIONS_AI_TEST_LIVE")
  local override = runner.getenv("POLLINATIONS_AI_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("POLLINATIONS_AI_TEST_EXPLAIN")
