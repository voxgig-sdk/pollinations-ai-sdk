...
local ImageGenerationEntity = {}
ImageGenerationEntity.__index = ImageGenerationEntity


function ImageGenerationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ImageGenerationEntity)
  self._name = "image_generation"
  self._client = client
...
function ImageGenerationEntity:get_name()
  return self._name
end


function ImageGenerationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ImageGenerationEntity.new(self._client, opts)
end
...
function ImageGenerationEntity:mark_deleted()
  self._deleted = true
end


function ImageGenerationEntity:deleted()
  return true == self._deleted
end


function ImageGenerationEntity:data_set(args)
  if args ~= nil then
...
function ImageGenerationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ImageGenerationEntity:match_set(args)
  if args ~= nil then
...
function ImageGenerationEntity:match_get()
...
function ImageGenerationEntity:stream(action, args, callopts)
...
function ImageGenerationEntity:_run_op(ctx, post_done)
  local utility = self._utility
