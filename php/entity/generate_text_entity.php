...
// PollinationsAi SDK GenerateText entity
...
class GenerateTextEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GenerateTextEntity($this->_client, $opts);
    }

    /**
     * @param GenerateText|array $args GenerateText data (assoc-array) to store.
     */
    ...
    /**
     * @return GenerateText|array The current GenerateText data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GenerateText fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GenerateText fields).
     */
    ...
    /**
     * Create a new GenerateText.
     *
     * @param GenerateTextCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GenerateTextCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GenerateText|array The created GenerateText as an assoc-array at the
