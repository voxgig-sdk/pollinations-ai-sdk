...
The PHP SDK for the PollinationsAi API. Provides an entity-oriented interface using PHP conventions.
...
```php
// Create
[$created, $_] = $client->GenerateText(null)->create(["name" => "Example"], null);
...
[$result, $err] = $client->PollinationsAi(null)->load(
    ["id" => "test01"], null
);
