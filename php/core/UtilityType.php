...
// PollinationsAi SDK utility type

class PollinationsAiUtility
{
    ...
    public static function copy(PollinationsAiUtility $src): PollinationsAiUtility
    {
        $u = new PollinationsAiUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
