...
class PollinationsAiSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = PollinationsAiHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = PollinationsAiHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!PollinationsAiFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, PollinationsAiFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return PollinationsAiUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = PollinationsAiHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = PollinationsAiHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = PollinationsAiHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new PollinationsAiError($op . "_allow",
                "PollinationsAiSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = PollinationsAiHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new PollinationsAiError("graphql_error",
                "PollinationsAiSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function GenerateText($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_generate_text === null) {
                $this->_generate_text = new GenerateTextEntity($this, null);
            }
            return $this->_generate_text;
        }
        return new GenerateTextEntity($this, $data);
    }
    ...
    public function ImageGeneration($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_image_generation === null) {
                $this->_image_generation = new ImageGenerationEntity($this, null);
            }
            return $this->_image_generation;
        }
        return new ImageGenerationEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new PollinationsAiSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
