...
// PollinationsAi SDK proxy feature
...
class PollinationsAiProxyFeature extends PollinationsAiBaseFeature
{
    ...
    public function init(PollinationsAiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PollinationsAiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
