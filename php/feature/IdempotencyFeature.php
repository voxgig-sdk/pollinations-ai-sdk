...
// PollinationsAi SDK idempotency feature
...
class PollinationsAiIdempotencyFeature extends PollinationsAiBaseFeature
{
    ...
    private function _mutating(PollinationsAiContext $ctx): bool
    {
