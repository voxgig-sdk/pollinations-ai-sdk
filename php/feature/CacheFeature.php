...
// PollinationsAi SDK cache feature
...
class PollinationsAiCacheFeature extends PollinationsAiBaseFeature
{
    ...
    private function _through(PollinationsAiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
