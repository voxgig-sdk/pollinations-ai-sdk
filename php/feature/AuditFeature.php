...
// PollinationsAi SDK audit feature
...
class PollinationsAiAuditFeature extends PollinationsAiBaseFeature
{
    ...
    private function _emit(PollinationsAiContext $ctx, string $outcome): void
    {
