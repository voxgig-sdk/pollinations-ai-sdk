...
// PollinationsAi SDK paging feature
...
class PollinationsAiPagingFeature extends PollinationsAiBaseFeature
{
    ...
    private function _is_list(PollinationsAiContext $ctx): bool
    {
