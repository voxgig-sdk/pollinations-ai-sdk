...
// PollinationsAi SDK metrics feature
...
class PollinationsAiMetricsFeature extends PollinationsAiBaseFeature
{
    ...
    private function _record(PollinationsAiContext $ctx, bool $ok): void
    {
