...
// PollinationsAi SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PollinationsAiSDK::test)
...
{
    private const SDK_CLASS = 'PollinationsAiSDK';
    ...
    private const SDK_BASE = 'pollinationsai_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../pollinationsai_sdk.php';
