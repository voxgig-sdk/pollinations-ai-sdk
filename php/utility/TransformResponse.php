...
// PollinationsAi SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class PollinationsAiTransformResponse
{
    public static function call(PollinationsAiContext $ctx): mixed
    {
        ...
        $transform = PollinationsAiHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
