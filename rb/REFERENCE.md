# PollinationsAi Ruby SDK Reference

Complete API reference for the PollinationsAi Ruby SDK.
...
#### `PollinationsAiSDK.test(testopts = nil, sdkopts = nil)`
...
| --- | --- | --- | --- |
| `choices` | `Array` | No |  |
| `created` | `Integer` | No | Unix timestamp of when the generation was created |
...
| `object` | `String` | No |  |
| `seed` | `Integer` | No | Seed for reproducible text generation |
