...
class ImageGenerationEntity
  ...
  def make
    opts = @_entopts.dup
    ImageGenerationEntity.new(@_client, opts)
  end
  ...
  # @return [ImageGeneration, Hash] the current ImageGeneration data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ImageGeneration fields)
  def match_get
