...
class ImageGenerationEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set POLLINATIONS_AI_TEST_IMAGE_GENERATION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def image_generation_basic_setup(extra)
  ...
  entid_env_raw = ENV["POLLINATIONS_AI_TEST_IMAGE_GENERATION_ENTID"]
