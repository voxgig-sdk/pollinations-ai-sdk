...
#      offline in seeded test mode (PollinationsAiSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "PollinationsAi_sdk.rb")
  SDK_CLASS = "PollinationsAiSDK"
