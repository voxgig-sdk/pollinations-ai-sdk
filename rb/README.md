...
The Ruby SDK for the PollinationsAi API — an entity-oriented client using idiomatic Ruby conventions.
...
```ruby
# Create
created, _ = client.GenerateText().create({ "name" => "Example" })
...
result, err = client.PollinationsAi().load({ "id" => "test01" })
