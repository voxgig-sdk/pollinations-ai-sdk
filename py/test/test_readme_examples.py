# PollinationsAi SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PollinationsAiSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PollinationsAiSDK(...) and PollinationsAiSDK.test(...) become
#      PollinationsAiSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "pollinationsai_sdk"
_SDK_CLASS = "PollinationsAiSDK"
