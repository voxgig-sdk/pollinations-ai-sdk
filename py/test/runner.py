...
class PollinationsAiTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PollinationsAiTestRunner.getenv("POLLINATIONSAI_TEST_LIVE")
        override = PollinationsAiTestRunner.getenv("POLLINATIONSAI_TEST_OVERRIDE")
        ...
        explain = PollinationsAiTestRunner.getenv("POLLINATIONSAI_TEST_EXPLAIN")
