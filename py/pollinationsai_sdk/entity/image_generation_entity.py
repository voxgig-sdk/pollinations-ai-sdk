...
from pollinationsai_sdk.pollinationsai_types import (
    ImageGeneration,
...
class ImageGenerationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ImageGenerationEntity(self._client, opts)
    ...
    def data_get(self) -> ImageGeneration:
    ...
    def match_get(self) -> ImageGeneration:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ImageGeneration:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ImageGeneration().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
