...
class GenerateTextEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GenerateTextEntity(self._client, opts)
    ...
    def data_get(self) -> GenerateText:
    ...
    def match_get(self) -> GenerateText:
    ...
    def create(self, reqdata: GenerateTextCreateData, ctrl=None) -> GenerateText:
        utility = self._utility
