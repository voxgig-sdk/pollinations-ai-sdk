...
from pollinationsai_sdk.utility import register

# Load features
from pollinationsai_sdk.feature.base_feature import PollinationsAiBaseFeature
from pollinationsai_sdk.features import _has_feature, _make_feature
...
class PollinationsAiSDK:
    ...
    def get_utility(self):
        return PollinationsAiUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PollinationsAiSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GenerateText(self, data=None) -> "GenerateTextEntity":
        ...
        from pollinationsai_sdk.entity.generate_text_entity import GenerateTextEntity
    ...
    def ImageGeneration(self, data=None) -> "ImageGenerationEntity":
        ...
        from pollinationsai_sdk.entity.image_generation_entity import ImageGenerationEntity
