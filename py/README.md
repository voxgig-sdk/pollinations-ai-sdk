# PollinationsAi Python SDK

The Python SDK for the PollinationsAi API. Provides an entity-oriented interface following Pythonic conventions.
...
```python
# Create
created, _ = client.GenerateText(None).create({"name": "Example"}, None)
...
result, err = client.PollinationsAi(None).load(
    {"id": "test01"}, None
)
...
```
py/
├── pollinationsai_sdk.py         -- Main SDK module
...
The main module (`pollinationsai_sdk`) exports the SDK class.
