...
// instead of `sdk.NewPollinationsAiSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *PollinationsAiSDK  { return NewPollinationsAiSDK(nil) }
func Test() *PollinationsAiSDK { return TestSDK(nil, nil) }
