...
func (sdk *PollinationsAiSDK) OptionsMap() map[string]any {
...
func (sdk *PollinationsAiSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *PollinationsAiSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *PollinationsAiSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PollinationsAiSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *PollinationsAiSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *PollinationsAiSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("PollinationsAiSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *PollinationsAiSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PollinationsAiSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("PollinationsAiSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *PollinationsAiSDK {
	...
	sdk := NewPollinationsAiSDK(sdkopts)
	sdk.Mode = "test"
