...
const testSeed = `map[string]any{"entity": map[string]any{"generate_text": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "image_generation": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
