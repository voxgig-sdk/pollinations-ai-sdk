...
func TestGenerateTextEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		generateTextRef01Data = core.ToMapAny(entityData(generateTextRef01DataResult))
...
func generate_textBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("POLLINATIONS_AI_TEST_GENERATE_TEXT_ENTID")
	...
	idmapResolved := core.ToMapAny(env["POLLINATIONS_AI_TEST_GENERATE_TEXT_ENTID"])
