...
type ImageGenerationEntity struct {
	name    string
...
func NewImageGenerationEntity(client *core.PollinationsAiSDK, entopts map[string]any) *ImageGenerationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ImageGenerationEntity) GetName() string { return e.name }
...
func (e *ImageGenerationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ImageGenerationEntity) Deleted() bool {
	return e.deleted
}


func (e *ImageGenerationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewImageGenerationEntity(e.client, opts)
}

func (e *ImageGenerationEntity) Data(args ...any) any {
...
func (e *ImageGenerationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *ImageGenerationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ImageGenerationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ImageGenerationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ImageGenerationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ImageGenerationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ImageGenerationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
