# PollinationsAi Golang SDK Reference

Complete API reference for the PollinationsAi Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *PollinationsAiSDK`
...
#### `GenerateText(data map[string]any) PollinationsAiEntity`

Create a new `GenerateText` entity instance. Pass `nil` for no initial data.

#### `ImageGeneration(data map[string]any) PollinationsAiEntity`
